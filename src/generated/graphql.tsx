...
export type LaunchIdQueryVariables = Exact<{
  id: Scalars['String'];
}>;
...
export type MissionListQuery = { __typename?: 'Query', launches?: Maybe<Array<Maybe<{ __typename?: 'Launch', mission_id?: Maybe<Array<Maybe<string>>>, mission_name?: Maybe<string>, launch_success?: Maybe<boolean>, launch_year?: Maybe<number> }>>> };


export const LaunchIdDocument = gql`
...
/**
 * __useLaunchIdQuery__
 *
 * To run a query within a React component, call `useLaunchIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useLaunchIdQuery(baseOptions: Apollo.QueryHookOptions<LaunchIdQuery, LaunchIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LaunchIdQuery, LaunchIdQueryVariables>(LaunchIdDocument, options);
      }
export function useLaunchIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchIdQuery, LaunchIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaunchIdQuery, LaunchIdQueryVariables>(LaunchIdDocument, options);
        }
export type LaunchIdQueryHookResult = ReturnType<typeof useLaunchIdQuery>;
export type LaunchIdLazyQueryHookResult = ReturnType<typeof useLaunchIdLazyQuery>;
export type LaunchIdQueryResult = Apollo.QueryResult<LaunchIdQuery, LaunchIdQueryVariables>;
...
export function useMissionListQuery(baseOptions?: Apollo.QueryHookOptions<MissionListQuery, MissionListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MissionListQuery, MissionListQueryVariables>(MissionListDocument, options);
      }
export function useMissionListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MissionListQuery, MissionListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MissionListQuery, MissionListQueryVariables>(MissionListDocument, options);
        }
